...
urlpatterns = [
    ...
    path('articles/rate/<int:pk>/', views.Article_Rate_View.as_view(), name='articles_rate_page'),
    ...
    path('comment_to_article/comment_delete/<int:pk>/', views.Comment_Delete_View.as_view(), name='comment_delete_page'),
